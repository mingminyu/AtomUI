...
class BGClientScopeManager:
    def __init__(self) -> None:
        self._client_scope_map: Dict[_TClientID, BGClientScope] = {}
    ...
    def get_scope(self):
        ...
        if client.id not in self._client_scope_map:
            self._client_scope_map[client.id] = BGClientScope()
